# -*- coding: utf-8 -*-
"""
Created on Thu Jul  9 16:06:12 2020
...
class TweetProcessor(object):
    ...
    def __init__(self, source, dest, source2=None):
        ...
        """
        self.dictionary = json.load(open(os.getcwd() + "/data.json"))
...
if __name__ == '__main__':
    ...
    train_pos_full = os.getcwd() + "/" + "train_pos.txt"
    train_neg_full = os.getcwd() + "/" + "train_neg.txt"
    train_processed_file_name = os.getcwd() + "/" + "train_preprocessed.txt"
    ...
    test_file_name = os.getcwd() + "/" + "test_data.txt"
    test_processed_file_name = os.getcwd() + "/" + "test_preprocessed.txt"
